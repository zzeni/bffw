<?php
    ...
    if (!empty($id)) :
        ...
        $hasExtendedSettings = SCFP()->getSettings()->hasExtendedSettings($selectedType);
        
?>
<div class="scfp-field-settings-box">
    ...
    <div class="scfp-field scfp-field-actions">    
        <a class="button agp-settings-row <?php echo !$hasExtendedSettings ? ' disabled' : ''; ?>" href="javascript:void(0);" title="Settings"><span class="dashicons dashicons-admin-generic"></span></a>
...
<div class="scfp-field-extended-settings-box">
    <?php echo SCFP()->getTemplate('admin/form/extended-settings/layout', array('selectedType' => $selectedType, 'params' => $params )); ?>        
</div>
