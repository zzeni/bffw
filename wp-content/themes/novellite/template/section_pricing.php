<section id="price-package" <?php if(get_theme_mod('pricing_img_first')!='') { ?>style="background-image: url(<?php echo get_theme_mod('pricing_img_first',''); ?>);" <?php } ?>>
  <div class="container">
      ...
      <div class="price-block">
        ...
        if($first_li !='' || $second_li != '' || $third_li != ''):
          ?>
            ...
            <?php if ($first_li != '') { ?>
              <li class="price-post">
                <div class="plan wow fadeInLeft" data-wow-duration="2s">
          ...
          <?php if ($second_li != '') { ?>
              <li class="price-post">
                <div class="plan featured wow fadeInUp" data-wow-duration="2s">
                  <div class="header-package">
          ...
          <?php if ($third_li != '') { ?>
              <li class="price-post">
                <div class="plan wow fadeInRight" data-wow-duration="2s">
                  <div class="header-package">
               ...
               <li class="price-post">
                <div class="plan wow fadeInLeft" data-wow-duration="2s">
                  <div class="header-package">
                    ...
                    <span class="price"><sup class="sup-up">$</sup> 125 <span class="sup-down">/ mo</span></span>
                  </div>
                  <ul class="plan-features">
