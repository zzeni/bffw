(function($) {  
    $(document).ready(function() { 
        ...
        $(document).on('click', '#agp-repeater-scfp_form_settings .agp-add-row', function(e) {
            ...
            var index2 = 'xxxxxxxxxxxx'.replace(/[xy]/g, function(c) {var r = Math.random()*16|0,v=c=='x'?r:r&0x3|0x8;return v.toString(16);});

            content = '<div class="agp-row scfp-field-row ui-sortable-handle" data-key="'+index+'">' + content.replace(/\[0\]/g, '[' + index + ']').replace(/_0_/g, '_' + index + '_').replace(/\[00\]/g, '[' + index2 + ']').replace(/_00_/g, '_' + index2 + '_') + '</div>';
