    ...
    <div class="scfp-settings-table-mobile-scroll">
        <div class="scfp-settings-table" id="scfp-sortable">
            ...
            <div class="scfp-settings-table-list">
                ...
                ?>
                    <div class="agp-row<?php echo $rowClass?> scfp-field-row"  data-key="<?php echo $key;?>">
                ...
                ?>
                    <div class="agp-row scfp-field-row" data-key="<?php echo $key;?>">                    
                ...
                <div class="agp-row agp-row-template scfp-field-row" style="display: none;">
                    <?php echo $obj->getRowTemplateAdmin(array('id' => $id, 'row' => 0, 'num' => 0)); ?>                    
                </div>
            </div>
        </div>
    </div>
