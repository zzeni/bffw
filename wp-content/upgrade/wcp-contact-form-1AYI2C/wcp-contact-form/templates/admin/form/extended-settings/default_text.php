...
<div class="scfp-field-extended-settings-row">
    ...
    <input class="widefat" type="text" value="<?php echo !empty($data['default']) && !is_array($data['default']) ? $data['default'] : '' ;?>" id="<?php echo "{$id}_{$row}_default";?>" name="<?php echo "{$id}[field_settings][{$row}][default]";?>" />     
