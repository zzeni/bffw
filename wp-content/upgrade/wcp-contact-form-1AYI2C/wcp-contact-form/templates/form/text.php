...
?>
    <div class="scfp-form-row<?php echo !empty($css_class) ? ' '.$css_class : '';?>">
        ...
        <input<?php if (!empty($placeholder)):?> placeholder="<?php echo $placeholder;?>"<?php endif;?> <?php echo $atts;?> class="scfp-form-field" type="text" id="scfp-<?php echo $key; ?>" name="scfp-<?php echo $key; ?>" <?php if ( !empty( $required ) && !empty($formSettings['html5_enabled']) ) : ?> required <?php endif;?> value="<?php echo $value; ?>">
